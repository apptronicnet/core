...
fun Contextual.gestureNavigationViewModel() = GestureNavigationViewModel(childContext())

class GestureNavigationViewModel internal constructor(context: Context) : ViewModel(context) {
