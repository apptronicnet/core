...
private val TranslationYToParentDescriptor = transformationDescriptor("TranslationYToParent")
...
class TranslationYToParentTransformation(
    ...
    override val descriptor: TransformationDescriptor = TranslationYToParentDescriptor
