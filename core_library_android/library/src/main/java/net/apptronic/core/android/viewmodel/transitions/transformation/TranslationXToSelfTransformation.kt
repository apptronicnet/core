...
private val TranslationXToSelfDescriptor = transformationDescriptor("TranslationXToSelf")
...
class TranslationXToSelfTransformation(
    ...
    override val descriptor: TransformationDescriptor = TranslationXToSelfDescriptor
