...
fun <T : ViewModelProperty<R>, R, A1> T.assignAsFunctionFrom(a1: ViewModelProperty<A1>,
                                                             function: (A1) -> R): T {
    forEachChange(a1) {
        set(function(a1.get()))
    }
...
fun <T : ViewModelProperty<R>, R, A1, A2> T.assignAsFunctionFrom(a1: ViewModelProperty<A1>,
...
fun <T : ViewModelProperty<R>, R, A1, A2, A3> T.assignAsFunctionFrom(a1: ViewModelProperty<A1>,
                                                                     a2: ViewModelProperty<A2>,
...
fun <T : ViewModelProperty<R>, R, A1, A2, A3, A4> T.assignAsFunctionFrom(a1: ViewModelProperty<A1>,
                                                                         a2: ViewModelProperty<A2>,
                                                                         a3: ViewModelProperty<A3>,
...
fun <T : ViewModelProperty<R>, R, A1, A2, A3, A4, A5> T.assignAsFunctionFrom(a1: ViewModelProperty<A1>,
                                                                             a2: ViewModelProperty<A2>,
                                                                             a3: ViewModelProperty<A3>,
                                                                             a4: ViewModelProperty<A4>,
