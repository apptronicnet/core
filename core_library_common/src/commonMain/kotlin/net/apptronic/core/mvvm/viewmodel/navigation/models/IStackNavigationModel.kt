...
interface IStackNavigationModel : INavigator<SingleItemNavigatorContent>,
     ...
     */
    fun replaceAll(viewModel: IViewModel, transitionInfo: Any? = null, navigationTransition: NavigationTransition = NavigationTransition.NewOnFront)

    /**
     * Build [ViewModel] replace all [ViewModel]s from stack by it
     */
    fun replaceAll(transitionInfo: Any? = null, navigationTransition: NavigationTransition = NavigationTransition.Auto, builder: Context.() -> IViewModel) {
     ...
     */
    fun add(viewModel: IViewModel, transitionInfo: Any? = null, navigationTransition: NavigationTransition = NavigationTransition.Auto)

    /**
     * Build [ViewModel] and add it to stack
     */
    fun add(transitionInfo: Any? = null, navigationTransition: NavigationTransition = NavigationTransition.Auto, builder: Context.() -> IViewModel) {
     ...
     */
    fun replace(viewModel: IViewModel, transitionInfo: Any? = null, navigationTransition: NavigationTransition = NavigationTransition.Auto)
     ...
     */
    fun replaceStack(newStack: List<IViewModel>, transitionInfo: Any? = null, navigationTransition: NavigationTransition = NavigationTransition.Auto)
     ...
     */
    fun replace(transitionInfo: Any? = null, navigationTransition: NavigationTransition = NavigationTransition.Auto, builder: Context.() -> IViewModel) {
     ...
     */
    fun remove(viewModel: IViewModel, transitionInfo: Any? = null, navigationTransition: NavigationTransition = NavigationTransition.Auto)
     ...
     * last or no model in stack
     */
    fun navigateBack(transitionInfo: Any?, navigationTransition: NavigationTransition = NavigationTransition.Auto, actionOnNonNavigate: () -> Unit = {}) {
     ...
     */
    fun popBackStackTo(viewModel: IViewModel, transitionInfo: Any? = null, navigationTransition: NavigationTransition = NavigationTransition.Auto): Boolean
